...
var seq__1654_1658 = cljs.core.seq.call(null,clojure.browser.repl.print_queue);
var chunk__1655_1659 = null;
var count__1656_1660 = (0);
var i__1657_1661 = (0);
while(true){
if((i__1657_1661 < count__1656_1660)){
var str_1662 = cljs.core._nth.call(null,chunk__1655_1659,i__1657_1661);
clojure.browser.net.transmit.call(null,conn,new cljs.core.Keyword(null,"print","print",1299562414),goog.json.serialize(({"repl": clojure.browser.repl._STAR_repl_STAR_, "str": str_1662})));


var G__1663 = seq__1654_1658;
var G__1664 = chunk__1655_1659;
var G__1665 = count__1656_1660;
var G__1666 = (i__1657_1661 + (1));
seq__1654_1658 = G__1663;
chunk__1655_1659 = G__1664;
count__1656_1660 = G__1665;
i__1657_1661 = G__1666;
continue;
} else {
var temp__5735__auto___1667 = cljs.core.seq.call(null,seq__1654_1658);
if(temp__5735__auto___1667){
var seq__1654_1668__$1 = temp__5735__auto___1667;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__1654_1668__$1)){
var c__4556__auto___1669 = cljs.core.chunk_first.call(null,seq__1654_1668__$1);
var G__1670 = cljs.core.chunk_rest.call(null,seq__1654_1668__$1);
var G__1671 = c__4556__auto___1669;
var G__1672 = cljs.core.count.call(null,c__4556__auto___1669);
var G__1673 = (0);
seq__1654_1658 = G__1670;
chunk__1655_1659 = G__1671;
count__1656_1660 = G__1672;
i__1657_1661 = G__1673;
continue;
} else {
var str_1674 = cljs.core.first.call(null,seq__1654_1668__$1);
clojure.browser.net.transmit.call(null,conn,new cljs.core.Keyword(null,"print","print",1299562414),goog.json.serialize(({"repl": clojure.browser.repl._STAR_repl_STAR_, "str": str_1674})));


var G__1675 = cljs.core.next.call(null,seq__1654_1668__$1);
var G__1676 = null;
var G__1677 = (0);
var G__1678 = (0);
seq__1654_1658 = G__1675;
chunk__1655_1659 = G__1676;
count__1656_1660 = G__1677;
i__1657_1661 = G__1678;
continue;
}
} else {
}
...
var script__$1 = (function (){var G__1683 = script;
goog.object.set(G__1683,"type","text/javascript");

goog.object.set(G__1683,"onload",onload);

goog.object.set(G__1683,"onreadystatechange",onload);

return G__1683;
})();
if((opt_sourceText == null)){
var G__1684 = script__$1;
goog.object.set(G__1684,"src",src);

return G__1684;
} else {
var G__1685 = script__$1;
goog.dom.setTextContent(G__1685,opt_sourceText);
...
var path_1686 = goog.debugLoader_.getPathFromDeps_(src);
goog.object.remove(goog.debugLoader_.written_,path_1686);

goog.object.remove(goog.debugLoader_.written_,[cljs.core.str.cljs$core$IFn$_invoke$arity$1(goog.basePath),cljs.core.str.cljs$core$IFn$_invoke$arity$1(path_1686)].join(''));
} else {
var path_1687 = goog.object.get(goog.dependencies_.nameToPath,src);
goog.object.remove(goog.dependencies_.visited,path_1687);

goog.object.remove(goog.dependencies_.written,path_1687);

goog.object.remove(goog.dependencies_.written,[cljs.core.str.cljs$core$IFn$_invoke$arity$1(goog.basePath),cljs.core.str.cljs$core$IFn$_invoke$arity$1(path_1687)].join(''));
}
} else {
}
...
return clojure.browser.net.transmit.call(null,repl_connection,new cljs.core.Keyword(null,"send-result","send-result",35388249),goog.json.serialize(({"repl": repl, "result": (function (){var _STAR_repl_STAR__orig_val__1688 = clojure.browser.repl._STAR_repl_STAR_;
var _STAR_repl_STAR__temp_val__1689 = repl;
(clojure.browser.repl._STAR_repl_STAR_ = _STAR_repl_STAR__temp_val__1689);

try{return clojure.browser.repl.evaluate_javascript.call(null,repl_connection,form);
}finally {(clojure.browser.repl._STAR_repl_STAR_ = _STAR_repl_STAR__orig_val__1688);
}})()})));
}));
